...
<head>
    ...
    <style>
        ...
        .comment-date{fout-style: italic}
    </style>
</head>
...
<div id = "comments-panel">
    ...
    <p <?php if ($comment['user_id'] == $_SESSION['user_id']) echo 'style="font-weight: bolt;"';?>><?php echo $comment['comment'];?><span class="comment-date">(<?php echo $comment['created'];?>)</span></span></p>
    <?php endforeach;?>
</div>
</body>
</html>
